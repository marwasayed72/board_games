...
public:
    Misere_Random_Player (T symbol ,const string& name = "random computer player");
...
template <typename T>
Misere_Random_Player<T>::Misere_Random_Player(T symbol , const string & name) : RandomPlayer<T>(symbol) {
    this->dimension = 3;
    this->name = name;
